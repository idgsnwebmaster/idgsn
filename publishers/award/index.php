		...
		<div id="header">
			...
			<div id="nav_container">
				<ul id="nav">
					...
					<!-- <li id="join_the_network<?php if ($section == "join_the_network") { ?>_active<?php } ?>"><a href="https://app.adify.com/Register.aspx?ReturnUrl=%2fMemberPages%2fApplyToNetwork.aspx%3fnetworkId%3d1708210">Join the Network</a></li> -->
