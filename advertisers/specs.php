...
<head>
	...
	<title>IDG TechNetwork | Online Specifications</title>
			...
			<div id="content">
				...
				<div id="column_container">
					...
					<div id="single_column">
						...
						<ul>
							...
							<li><strong>Sound</strong>
								<ul>
									...
									<li>Must have a control button to turn off sound</li>
								</ul>
							</li>
							<li><strong>Pre-roll </strong>
								<ul>
									<li>30 second maximum</li>
								</ul>
							</li>
						</ul>
						<h3>Banner Ads</h3>
						...
						<h4>300x250 (IMU)&nbsp; </h4>
						<ul>
							<li>Expandable units</li>
							<li>Left only</li>
							<li>Maximum size: 600x250</li>
						</ul>
						<h4>336x280 (IMU)&nbsp; </h4>
						<ul>
							<li>Expandable units</li>
							<li>Left only</li>
							<li>Maximum size: 672x280</li>
						</ul>
						<h4>728x90 (Leaderboard)</h4>
						<ul>
							<li>Expandable units</li>
							<li>Bottom only</li>
							<li>Maximum size: 728x225</li>
						</ul>
						<h4>160x600 (Skyscraper)</h4>
						<ul type="disc">
							<li>Expandable units</li>
							<li>Right only</li>
							<li>Maximum size: 400x600</li>
						</ul>
						...
						<h4>Ez-Blaster Units</h4>
						<p>These units are custom designed by IDG TechNetwork. These units
						are located under the 336x280 ad unit; when user rolls over the company
						logo and teaser, unit will expand to a 620x250 ad with interactive
						features.</p>
						<ul type="disc">
							<li>Company logo</li>
						...
						<h4>White Papers</h4>
						<ul type="disc">
							<li>Must include title of white paper</li>
							<li>50-word summary </li>
							<li>Link to PDF file or actual PDF file </li>
							<li><strong>Due Date</strong>: Please allow 5 business days before
							live date.</li>
						</ul>
					</div>
